...
describe('number names', () => {
  ...
  describe('convertLatgeToWord()', () => {
    ;[
      ...
      {
        in: 10000001000,
        out: 'ten billion, one thousand',
      },
      {
        in: 10000001100,
        out: 'ten billion, one thousand, one hundred',
      },
      {
        in: 10000001101,
        out: 'ten billion, one thousand, one hundred and one',
      },
      {
        in: -10000001000,
        out: 'negative ten billion, one thousand',
      },
    ].forEach(testData => {
      it(`outputs "${testData.out}" when input is ${testData.in}`, () => {
